...
Concrete TS idioms (naming, error handling, async, narrowing) live in the `ts-patterns` skill and the user's global TypeScript Base rules — do not restate them here.

#!/bin/bash
# Guardrails Hook — branch-aware allow / ask / deny for git commit/push and gh pr merge
# Triggered: PreToolUse (matcher Bash). Config: $CLAUDE_PROJECT_DIR/.claude/project-profile/guardrails.json
